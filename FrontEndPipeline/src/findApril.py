...
def detect_high_accuracy_marker_zero_april(image):
    """
    Detects April marker ID=42 in an image and applies sub-pixel 
...
if __name__ == "__main__":
    print(detect_high_accuracy_marker_zero_april(r"C:\Users\Mike\Desktop\Senior Design\frames\frame_0000.png"))